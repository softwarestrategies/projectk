...
INSERT INTO projectk_user(created_by, modified_by, username, first_name, last_name, status)
VALUES
    ('bootstrap', 'bootstrap', 'admin.test@softwarestrategies.io', 'Admin', 'Smith', 'A'),
    ('bootstrap', 'bootstrap', 'user1.test@softwarestrategies.io', 'User1', 'Jones', 'A'),
    ('bootstrap', 'bootstrap', 'user2.test@softwarestrategies.io', 'User2', 'Franklin', 'A');
